'********** create .NET Controller : clsControllerABLE100.vb ****************

Public Class clsControllerTABLE01
    Implements IDisposable

    Public Property prop_dtABLE01 As DataTable

    Private Function dtCreateABLE01() As DataTable
        ...
        Dim fieldf02Memo As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f02Memo", .DefaultValue = ""}
    ...
    Public Sub dtInitABLE01()
        prop_dtABLE01 = Nothing
        prop_dtABLE01 = dtCreateABLE01()
        prop_dtABLE01.Clear()
    End Sub

    Public Sub dtAddNewABLE01(ByVal prmk01String As String, ByVal prmk02Int As Integer, ByVal prmk03String As String, ByVal prmk04String As String, ByVal prmk05String As String, ByVal prmf01String As String, ByVal prmf02String As String, ByVal prmf03String As String, ByVal prmf04String As String, ByVal prmf05String As String, ByVal prmf06String As String, ByVal prmf07String As String, ByVal prmf08String As String, ByVal prmf09String As String, ByVal prmf10String As String, ByVal prmf11String As String, ByVal prmf12String As String, ByVal prmf13String As String, ByVal prmf14String As String, ByVal prmf15String As String, ByVal prmf16String As String, ByVal prmf17String As String, ByVal prmf18String As String, ByVal prmf19String As String, ByVal prmf20String As String, ByVal prmf21String As String, ByVal prmf22String As String, ByVal prmf23String As String, ByVal prmf24String As String, ByVal prmf25String As String, ByVal prmf26String As String, ByVal prmf27String As String, ByVal prmf28String As String, ByVal prmf29String As String, ByVal prmf30String As String, ByVal prmf01Memo As String, ByVal prmf02Memo As String, ByVal prmf01Int As Integer, ByVal prmf02Int As Integer, ByVal prmf03Int As Integer, ByVal prmf04Int As Integer, ByVal prmf05Int As Integer, ByVal prmf06Int As Integer, ByVal prmf07Int As Integer, ByVal prmf01Double As Double, ByVal prmf02Double As Double, ByVal prmf03Double As Double, ByVal prmf04Double As Double, ByVal prmf05Double As Double, ByVal prmf06Double As Double, ByVal prmf07Double As Double, ByVal prmf01Double16 As Double, ByVal prmf02Double16 As Double, ByVal prmf03Double16 As Double, ByVal prmf04Double16 As Double, ByVal prmf05Double16 As Double, ByVal prmf01Date As Date, ByVal prmf02Date As Date, ByVal prmf03Date As Date, ByVal prmf04Date As Date, ByVal prmf05Date As Date, ByVal prmf01Datetime As Date, ByVal prmf02Datetime As Date, ByVal prmf01IDUser As String, ByVal prmf02IDUser As String, ByVal prmf01NamaUser As String, ByVal prmf02NamaUser As String)

        Dim oDataRow As DataRow = prop_dtABLE01.NewRow()
        ...
        prop_dtABLE01.Rows.Add(oDataRow)
    End Sub
...
'********** end of .NET Controller : clsControllerABLE100.vb ****************
