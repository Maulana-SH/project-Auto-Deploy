...
Public Class ctrl35SKOJOBCARD
    Inherits SearchLookUpEdit
    Implements IDisposable

    Public Property _01prop_dtMasterSKOJobcard As New DataTable

    Private objColValueMember As GridColumn

    Public Sub _02BindingAwalDataSurce()
        Const pcfieldValueMember As String = "f01cNoJobCard_v50"
        ...
        Properties.DataSource = _01prop_dtMasterSKOJobcard
    End Sub

    Public Function _03GetRecordTerpilih() As DataRow()
        Dim pdtCopy As DataTable
        pdtCopy = _01prop_dtMasterSKOJobcard

        Dim pdDataRow() As DataRow
        pdDataRow = pdtCopy.Select("f01cNoJobCard_v50 = '" & Me.EditValue & "'")
