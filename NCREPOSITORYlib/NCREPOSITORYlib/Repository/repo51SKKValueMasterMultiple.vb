...
Public Class repo51SKKValueMasterMultiple
    ...
    Public Function _05GetEditValue() As List(Of String)
        Me.EditValueType = EditValueTypeCollection.List

        Dim valuesCode As List(Of String) = Me.GetCheckedItems()

        'Dim displayValues As List(Of String) = Me.GetCheckedItems()
        'Dim valuesCode As List(Of String) = displayValues.Split(Me.SeparatorChar).ToList()
    ...
    Private Sub repo51SKKValueMasterMultiple_Popup(sender As Object, e As EventArgs) Handles Me.Popup
